...
`scripts/requiem_clean.py`, `docs/assets/app.js`, `data/pilot/index.json`
(+ cópia em docs). Mudanças aditivas; o `index.json` idealmente deve ser
**gerado por script** que varre `data/pilot/*.json` (elimina o pior conflito).
